<template>
  ...
  <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
    <NuxtLink to="/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-red-500 mb-8">
    ...
    <p class="mt-6">Welcome to Apollo Ambulance Service Inc. These Terms of Service ("Terms") govern your access to and use of Apollo Ambulance Service Inc's website, services, and applications (the "Service"). Please read these Terms carefully, and contact us if you have any questions. By accessing or using our Service, you agree to be bound by these Terms and our Privacy Policy.</p>

    <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">1. Definitions</h2>
    <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
      <li class="flex gap-x-3">
        <span><strong class="font-semibold text-gray-900">"Company"</strong> refers to Apollo Ambulance Service Inc, 1401 21st Street Suite R
Sacramento California 95811.</span>
      </li>
      <li class="flex gap-x-3">
        <span><strong class="font-semibold text-gray-900">"Service"</strong> refers to the website, applications, and services provided by Apollo Ambulance Service Inc.</span>
      </li>
      <li class="flex gap-x-3">
    ...
    <p class="mt-6">You may use our Service only if you can form a binding contract with Apollo Ambulance Service Inc, and only in compliance with these Terms and all applicable laws. When you create your Apollo Ambulance Service Inc account, you must provide us with accurate and complete information. Any use or access by anyone under the age of 18 is prohibited.</p>
    ...
    <p class="mt-6">The Service and its original content, features, and functionality are and will remain the exclusive property of Apollo Ambulance Service Inc and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Apollo Ambulance Service Inc.</p>

    <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">6. Links to Other Websites</h2>
    <p class="mt-6">Our Service may contain links to third-party websites or services that are not owned or controlled by Apollo Ambulance Service Inc. Apollo Ambulance Service Inc has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party websites or services.</p>
    ...
    <p class="mt-6">If you have any questions about these Terms, please contact us at esteban@Apollo Ambulance Service Inc.io</p>
  </div>
</div>
</template>
<script setup>
import { CheckCircleIcon, ArrowLeftIcon } from '@heroicons/vue/20/solid'
</script>