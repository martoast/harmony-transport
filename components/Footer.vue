<template>
      ...
      <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
        ...
        <div class="mt-24 border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
          <div>
            ...
            <p class="mt-4 text-sm text-gray-600">Providing exceptional medical transportation services since 2005. Licensed and certified across multiple states.</p>
            <div class="mt-4">
        ...
        <div class="mt-12 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          <div class="flex gap-x-6 md:order-2">
            <a v-for="item in navigation.social" :key="item.name" :href="item.href" class="text-gray-600 hover:text-red-600">
  ...
  const navigation = {
    ...
    resources: [
      ...
      { name: 'Provider Portal', href: '/providers' },
    ],
    legal: [
